...
public class CircleProgressBar extends ProgressBar {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mLineWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_line_width, UnitUtils.dp2px(getContext(), DEFAULT_LINE_WIDTH));
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_size, UnitUtils.dp2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_stroke_width, UnitUtils.dp2px(getContext(), DEFAULT_PROGRESS_STROKE_WIDTH));
